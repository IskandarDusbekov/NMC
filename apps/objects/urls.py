...
from .views import (
    ...
    ConstructionObjectExpenseCategoryDetailView,
...
urlpatterns = [
    ...
    path('objects/<int:pk>/expenses/<int:category_id>/', ConstructionObjectExpenseCategoryDetailView.as_view(), name='expense-category-detail'),
